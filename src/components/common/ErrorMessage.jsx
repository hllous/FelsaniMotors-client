...
/**
 * Componente ErrorMessage - Muestra mensajes de error, advertencia, éxito o información
 * @param {string} message - El mensaje a mostrar
 * @param {string} type - Tipo de mensaje: 'error', 'warning', 'success', 'info' (default: 'error')
 * @param {function} onClose - Función opcional para cerrar el mensaje
...
const ErrorMessage = ({ 
  ...
  return (
    <div 
      className={`border-l-4 p-4 rounded-md ${currentStyle.container} ${className}`}
      role="alert"
    >
      <div className="flex">
          ...
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                onClick={onClose}
                className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${currentStyle.closeBtn}`}
                aria-label="Cerrar"
              >
